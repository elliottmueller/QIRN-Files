...
def run():
    ...
    concbutton_photo = concbutton_photo.resize((200,35), Image.Resampling.LANCZOS)
    concbutton_photo = ImageTk.PhotoImage(concbutton_photo)
    
    isotopebutton_photo = Image.open('GUI_Illustrations/isotope.png')
    isotopebutton_photo = isotopebutton_photo.resize((200,35), Image.Resampling.LANCZOS)
    ...
    isotopeTIMEbutton_photo = isotopeTIMEbutton_photo.resize((200,35), Image.Resampling.LANCZOS)
...
def open(window):
    ...
    if window == 'fluxes':
        ...
        logo1 = logo1.resize((300,150), Image.Resampling.LANCZOS)
...
logo = logo.resize((700,575), Image.Resampling.LANCZOS)
